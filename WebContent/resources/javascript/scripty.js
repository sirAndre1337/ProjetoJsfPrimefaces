...
function redirecionarPagina(contextPath , pagina) {
	pagina = pagina + ".jsf";
	document.location = contextPath + pagina;
}
...
function validarSenhaLogin() {
	...
	if (j_username  === null || j_username.trim() === '') {
		alert("Informe o login por favor.");
		$('#j_username').focus();
		return false;
	}
...
/**
 * Sobrescrevendo o metodo para o calendario do primefaces ficar em Portugues.
 */
